...
# find peak of the first part of the list and compare
# with the peak of the second list
...
def find_peak(list_of_integers):
    ...
    if peak > list_of_integers[mid_val -
                               1] and peak > list_of_integers[mid_val + 1]:
        # print(peak)
        return peak
